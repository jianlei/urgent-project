...
(function ($) {
    ...
    function _2f6(_2f7, _2f8, _2f9) {
        ...
        function _2fc(dir) {
            ...
            var p = $("<div></div>").appendTo(_2f7).panel({cls: "layout-expand", title: "&nbsp;", closed: true, doSize: false, tools: [
...
(function ($) {
    ...
    $.fn.propertygrid.parseOptions = function (_5fa) {
        var t = $(_5fa);
        return $.extend({}, $.fn.datagrid.parseOptions(_5fa), $.parser.parseOptions(_5fa, [
            {showGroup: "boolean"}
        ]));
    };
    ...
    ], showGroup: false, groupField: "group", groupFormatter: function (_619, rows) {
        return _619;
    }});
})(jQuery);
(function ($) {
