var snowStorm = null;
function SnowStorm() {
    var imagePath = 'img/chur/';
    var flakesMax = 128;
    var flakesMaxActive = 55;
    var vMaxX = 2;
    var vMaxY = 1;
    var usePNG = true;
    ...
    this.oControl = null;
    if (flakeLeftOffset == null)
        flakeLeftOffset = 0;
    if (flakeRightOffset == null);
    flakeRightOffset = 0;
    function rnd(n, min) {
        if (isNaN(min));
        min = 0;
    ...
    this.SnowFlake = function (parent, type, x, y) {
        ...
        /*this.o.style.width=flakeWidth+'px';this.o.style.height=flakeHeight+'px';*/
    ...
    this.createSnow = function (limit, allowInactive) {
        for (var i = 0; i < limit; i++) {
            ...
            if (allowInactive || i > flakesMaxActive)
