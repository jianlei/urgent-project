...
import com.daren.core.web.wicket.data.Product.Vendor;
...
public class ProductsDAO {
    ...
    public ProductsDAO() {
        ...
        this.list.add(new Product(1, "Chai", "10 boxes x 20 bags", 18.0000, new Product.Vendor("vendor #1")));
        this.list.add(new Product(2, "Chang", "24 - 12 oz bottles", 19.0000, new Product.Vendor("vendor #2")));
        this.list.add(new Product(3, "Aniseed Syrup", "12 - 550 ml bottles", 10.0000, new Product.Vendor("vendor #3")));
        this.list.add(new Product(4, "Chef Anton's Cajun Seasoning", "48 - 6 oz jars", 22.0000, new Product.Vendor("vendor #4")));
        this.list.add(new Product(5, "Chef Anton's Gumbo Mix", "36 boxes", 21.3500, new Product.Vendor("vendor #5")));
        this.list.add(new Product(6, "Grandma's Boysenberry Spread", "12 - 8 oz jars", 25.0000, new Product.Vendor("vendor #1")));
        this.list.add(new Product(7, "Uncle Bob's Organic Dried Pears", "12 - 1 lb pkgs.", 30.0000, new Product.Vendor("vendor #2")));
        this.list.add(new Product(8, "Northwoods \"Cranberry\" Sauce", "12 - 12 oz jars", 40.0000, new Product.Vendor("vendor #3")));
        this.list.add(new Product(9, "Mishi Kobe Niku", "18 - 500 g pkgs.", 97.0000, new Product.Vendor("vendor #4")));
        this.list.add(new Product(10, "Ikura", "12 - 200 ml jars", 31.0000, new Product.Vendor("vendor #5")));
