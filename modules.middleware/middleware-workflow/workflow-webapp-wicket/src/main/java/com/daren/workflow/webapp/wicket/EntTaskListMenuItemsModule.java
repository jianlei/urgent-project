...
public class EntTaskListMenuItemsModule implements IMenuItemsModule {
    ...
    public String getName() {
        return "驳回的申请";  //To change body of implemented methods use File | Settings | File Templates.
    }
