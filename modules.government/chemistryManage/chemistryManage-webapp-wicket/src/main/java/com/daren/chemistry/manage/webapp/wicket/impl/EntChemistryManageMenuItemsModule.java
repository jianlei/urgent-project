...
public class EntChemistryManageMenuItemsModule implements IMenuItemsModule {
    ...
    public String getName() {
        return "危险化学品经营许可证";  //To change body of implemented methods use File | Settings | File Templates.
    }
    ...
    public Panel getPanel(String id, WebMarkupContainer wmc) {
        return new ChemistryManageTabPage(id, wmc, "enterprise");
    }
}