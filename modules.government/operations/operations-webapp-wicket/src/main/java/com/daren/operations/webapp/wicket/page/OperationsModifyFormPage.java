 ...
 * @修改备注：
 */
public class OperationsModifyFormPage extends BaseFormPanel {
    @Inject
    ...
    public OperationsModifyFormPage(String id, final IModel<Task> model) {
        super(id, model);
        ...
        final Form<OperationsBean> form = new Form<>("startForm", new CompoundPropertyModel<>(bean));
        ...
        form.add(new TextField("workType").setOutputMarkupId(true));
        form.add(new TextField("operationProject").setOutputMarkupId(true));
        ...
        form.add(new AjaxButton("save", form) {
            ...
            protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
                try {
                    ...
                    target.add(OperationsModifyFormPage.this.findParent(TabbedPanel.class));
                } finally {
        ...
        form.add(new IrisIndicatingAjaxLink("cancel") {
            ...
            public void onClick(AjaxRequestTarget target) {
                TabsUtil.deleteTab(target, OperationsModifyFormPage.this.findParent(TabbedPanel.class));
            }
        });
        DataProvider dataProvider=new DataProvider(bean.getId(), "operations");
