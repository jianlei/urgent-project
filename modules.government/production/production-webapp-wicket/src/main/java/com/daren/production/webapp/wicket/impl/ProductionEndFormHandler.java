...
import com.daren.production.webapp.wicket.page.ProductionEndFormPage;
 ...
 * @修改备注：
 */
public class ProductionEndFormHandler implements IFormHandler{
    @Override
    public Panel getPanel(String id, IModel model) {
        return new ProductionEndFormPage(id,model);
    }
