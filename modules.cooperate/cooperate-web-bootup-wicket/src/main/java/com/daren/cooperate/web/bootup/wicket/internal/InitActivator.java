package com.daren.cooperate.web.bootup.wicket.internal;
...
//        注册一个测试filter
//        DelegatingFilterFactory delegatingFilterFactory = new DelegatingFilterFactory(bundleContext, "daren.project.cooperate", 2);
