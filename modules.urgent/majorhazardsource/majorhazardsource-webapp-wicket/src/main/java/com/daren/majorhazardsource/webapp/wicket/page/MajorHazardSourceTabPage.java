...
public class MajorHazardSourceTabPage extends BasePanel {
    ...
    MajorHazardSourceCreatePage majorHazardSourceCreatePage;

    public MajorHazardSourceTabPage(String id, WebMarkupContainer wmc) {
        super(id, wmc);
        //增加tabs支持
    ...
    private MajorHazardSourcePage initMajorHazardSourcePage(final String id, final WebMarkupContainer wmc) {
        MajorHazardSourcePage majorHazardSourcePage = new MajorHazardSourcePage(id, wmc) {
            @Override
    ...
    private void initMajorHazardSourceCreatePage(final String id, final WebMarkupContainer wmc, final MajorHazardSourceBean majorHazardSourceBean, AjaxRequestTarget target,boolean goPage) {
        if (null == createAjaxTab) {
            createAjaxTab = new AjaxTab(Model.of("重大危险源编辑")) {
                ...
                public WebMarkupContainer getLazyPanel(String panelId) {
                    majorHazardSourceCreatePage = new MajorHazardSourceCreatePage(createPage.newChildId(), wmc, majorHazardSourceBean) {
                        @Override
                    ...
                    createFragment = new Fragment(panelId, "panel-3", MajorHazardSourceTabPage.this);
