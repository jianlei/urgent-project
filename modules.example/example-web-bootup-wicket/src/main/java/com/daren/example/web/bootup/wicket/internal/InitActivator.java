package com.daren.example.web.bootup.wicket.internal;
...
//        注册一个测试filter
//        DelegatingFilterFactory delegatingFilterFactory = new DelegatingFilterFactory(bundleContext, "example.simple.default", 2);
